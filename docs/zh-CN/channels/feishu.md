...
| `channels.feishu.encryptKey`                      | Required in webhook mode         | -                |
| `channels.feishu.webhookPath`                     | Webhook route path              | `/feishu/events` |
| `channels.feishu.webhookHost`                     | Webhook bind host              | `127.0.0.1`      |
| `channels.feishu.webhookPort`                     | Webhook bind port              | `3000`           |
| `channels.feishu.accounts.<id>.appId`             | App ID                         | -                |
| `channels.feishu.accounts.<id>.appSecret`         | App Secret                     | -                |
| `channels.feishu.accounts.<id>.domain`            | Override API domain per account | `feishu`         |
| `channels.feishu.dmPolicy`                        | Private message policy           | `pairing`        |
| `channels.feishu.allowFrom`                       | Private message allowlist (`open_id` list) | -  |
...
| `channels.feishu.blockStreaming`                  | Enable chunked streaming       | `true`           |
