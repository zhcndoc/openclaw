---
summary: "与 MITRE ATLAS 框架对应的 OpenClaw 威胁模型"
...
| **描述**             | 攻击者在配对宽限期内截获配对码（DM 渠道配对 1 小时，节点配对 5 分钟） |
| **攻击向量**         | 肩窥、网络嗅探、社会工程                                                        |
| **影响组件**         | 设备配对系统                                                                                         |
| **当前缓解措施**     | 1 小时过期（DM 配对）/ 5 分钟过期（节点配对），代码通过现有渠道发送                            |
| **剩余风险**         | 中等 - 宽限期可利用                                                                             |
| **建议**             | 缩短宽限期，增加确认步骤                                                                    |
