...
macOS 应用使用 `WKWebView` 嵌入了一个由代理控制的 **Canvas 面板**。它是一个轻量级的 HTML/CSS/JS、A2UI 和小型交互式 UI 工作区。
...
{"surfaceUpdate":{"surfaceId":"main","components":[{"id":"root","component":{"Column":{"children":{"explicitList":["title","content"]}}}},{"id":"title","component":{"Text":{"text":{"literalString":"Canvas (A2UI v0.8)"},"usageHint":"h1"}}},{"id":"content","component":{"Text":{"text":{"literalString":"如果你能读到这条消息，A2UI 推送就成功了。"},"usageHint":"body"}}}]}}
