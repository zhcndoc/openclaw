---
summary: "为 OpenClaw 添加 Qwen、Qwen Cloud、Model Studio、DashScope、Qwen Oauth、Qwen Portal、Qwen CLI 模型提供方支持。"
read_when:
  - 你正在安装、配置或审计 qwen 插件
title: "Qwen 插件"
---
...
为 OpenClaw 添加 Qwen、Qwen Cloud、Model Studio、DashScope、Qwen Oauth、Qwen Portal、Qwen CLI 模型提供方支持。
