...
| 标志        | 作用                                                                                                                                                                                                                                                                                                                                                                       |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--deep`    | 探测向量存储、嵌入提供商和语义搜索的就绪状态（意味着会额外调用提供商）。普通的 `memory status` 会保持快速并跳过此步骤；完整的持久化索引会显示为 `indexed (unprobed)`，而未知的向量/语义状态表示尚未进行探测。QMD 词法 `searchMode: "search"` 始终跳过语义向量探测，即使使用了 `--deep`。 |
| `--index`   | 如果存储处于脏状态，则重新建立索引。意味着使用 `--deep`。                                                                                                                                                                                                                                                                                                                             |
| `--fix`     | 修复过期的召回锁，并规范化提升元数据。                                                                                                                                                                                                                                                                                                                  |
| `--json`    | 输出 JSON。                                                                                                                                                                                                                                                                                                                                                                  |
| `--verbose` | 输出每个阶段的详细日志。                                                                                                                                                                                                                                                                                                                                                |
